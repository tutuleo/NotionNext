...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '图图', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '欢迎来到我的播客', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.102758.xyz', // 网站地址
